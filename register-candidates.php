  ...
  <div class="wrapper">
            ...
            <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
              <div class="col-md-6 latest-job ">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control input-lg" type="date" id="dob" min="1990-01-01" max="2050-01-31" name="dob" placeholder="Date Of Birth">
                </div>
                <div class="form-group">
    ...
    <footer class="main-footer" style="margin-left: 0px;">
      <div class="text-center">
        <strong>Copyright &copy; 2023 <a href="learningfromscratch.online">VIT Placement Portal</a>.</strong> All rights
        reserved.
      </div>
    </footer>
